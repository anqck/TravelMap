...
public abstract class AbstractPlaces extends AsyncTask<Void, Void, List<Place>> {
    ...
    protected SearchType searchType = SearchType.NearbySearch;
    protected final String PARAM_KEY = "key=";
    protected final String PARAM_QUERY = "query=";
    ...
    protected String TEXT_PLACES_URL = "https://maps.googleapis.com/maps/api/place/textsearch/json?";
    protected String LOCATION_PLACES_URL = "https://maps.googleapis.com/maps/api/geocode/json?";
