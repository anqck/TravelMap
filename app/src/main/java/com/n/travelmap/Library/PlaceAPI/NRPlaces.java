...
public class NRPlaces extends AbstractPlaces {
    ...
    private NRPlaces(Builder builder) {
        ...
        if(builder.searchType == SearchType.NearbySearch || builder.searchType == SearchType.LocationSearch )
        {
        ...
        else if(builder.searchType == SearchType.TextSearch)
        {
    ...
    protected String constructURL(String nexPageToken) {
        ...
        if(searchType == SearchType.NearbySearch)
            builder = new StringBuilder(PLACES_URL);
        else if (searchType == SearchType.TextSearch)
            builder = new StringBuilder(TEXT_PLACES_URL);
        else
            builder = new StringBuilder(LOCATION_PLACES_URL);
        ...
        if(searchType == SearchType.NearbySearch ||searchType == SearchType.LocationSearch )
        {
            if (location == null) {
        ...
        else
        {
            ...
            builder.append("&").append(PARAM_QUERY).append(searchText.replaceAll(" ","+"));
        }
    ...
    public static final class Builder {
        ...
        public Builder searchtype(SearchType val) {
            searchType = val;
            return this;
        }
